...
type Stub struct {
	...
	MutationResolver struct {
		ArrayIsNull func(ctx context.Context, array []bool) (bool, error)
	}
...
func (r *stubMutation) ArrayIsNull(ctx context.Context, array []bool) (bool, error) {
	return r.MutationResolver.ArrayIsNull(ctx, array)
}
